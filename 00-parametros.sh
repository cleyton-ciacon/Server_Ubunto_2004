#!/bin/bash
#============================================================================================
# Autor: Robson Vaamonde  # Github: https://github.com/vaamonde vrs clonado Versão: 0.82
# Data de criação: 10/10/2021 # Data de atualização: 05/10/2022# 
#=============================================================================================
# Atualizado por Cleyton Heusser em 19/10/2022                                               #
#                                                                                            #
...
# 07. tcpdump -vv -n -i enp2s0 port bootps or port bootpc = dump dos pacotes do ISC DHCP
#
...
# 10. /var/lib/bind/dev.intra.hosts = arquivo de configuração da Zona de Pesquisa Direta
# 11. /var/lib/bind/192.168.101.rev = arquivo de configuração da Zona de Pesquisa Reversas
...
DOMAINREV="101.168.192.in-addr.arpa"
#
...
# 02. less /var/lib/bind/dev.intra.hosts = arquivo de configuração da Zona de Pesquisa Direta
# 03. less /var/lib/bind/192.168.101.rev = arquivo de configuração da Zona de Pesquisa Reversas
#
...
AGENDAJAVAEE="https://github.com/professorjosedeassis/javaEE/raw/main/agendaCiacon.war"
#
...
# PASSWORD('ciacon2484') nova senha do usuário ocs
