#!/bin/bash
#============================================================================================
# Autor: Robson Vaamonde Github: https://github.com/vaamonde 
# Data de criação: 16/10/2021 # Data de atualização: 05/05/2022 # Versão: 0.14
#=============================================================================================
...
#	certutil -d sql:$HOME/.pki/nssdb -A -t "C,," -n BoraParaPratica -i dev-ca.crt
...
# imported: srvlnxws.dev.intra: Certificate already exists.
...
#			ls -lha /etc/ssl/certs/dev-ca.pem
#
# Instalação da Autoridade Certificadora CA no Microsoft Windows (10 ou 11)
# Pasta: Download
#		dev-ca.crt (clicar duas vezes em cima do certificado)
#			Abrir
...
#
# Verificando se as dependências do OpenSSL estão instaladas (openssl bind9 apache2)
...
echo -e "Criando o arquivo CSR (Certificate Signing Request), confirme as mensagens do arquivo: ca.conf, aguarde...\n"
	...
	# 	Organization Name (eg, company): Ciacon Desenvolvimento <-- pressione <Enter>
	# 	Organization Unit Name (eg, section): Procedimentos em TI <-- pressione <Enter>
	# 	Common Name (eg, server FQDN or YOUR name): srvlnxws.dev.intra <-- pressione <Enter>
	# 	Email Address: dev@dev.intra <-- pressione <Enter>
	#
...
echo -e "Criando o arquivo CRT (Certificate Request Trust), confirme as mensagens do arquivo: ca.conf, aguarde...\n"
	...
	# 	Locality Name (eg, city): Sao Paulo <-- pressione <Enter>
	# 	Organization Name (eg, company): Ciacon Desenvolvimento <-- pressione <Enter>
	# 	Organization Unit Name (eg, section): Ciacon Dev <-- pressione <Enter>
	# 	Common Name (eg, server FQDN or YOUR name): dev.intra <-- pressione <Enter>
	# 	Email Address: dev@dev.intra <-- pressione <Enter>
	#
